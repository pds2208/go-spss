...
func WriteToFile(fileName string, rows interface{}) error {
	...
	val := Export(fileName, "Test SAV from GO", header, data)

	log.Printf("Finished writing to: %s, return value: %d", fileName, val)
