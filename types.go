...
type HandleImport func(fileName ImportFile) int

type ImportFile interface {
    Import(fileName ImportFile) int
}

func (imp HandleImport) Import(fileName ImportFile) int {
    return imp(fileName)
}

var ImportSavFile = HandleImport(Import)
